...
public abstract class HTTPResponseHandler {
    ...
    private static final String STATUS_CODE = "ic-code";

    private static final String STATUS_MESSAGE = "ic-message";

    private static final String EXTERNAL_MESSAGE = "ic-external-message";
    ...
    public void setStatusHeadersToCreated(HttpServletResponse response) {
        int status = HttpStatus.CREATED.value();
        setStatusHeaders(response, status, "CREATED", "Created");
    }
